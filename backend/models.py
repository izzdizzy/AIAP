"""
Pydantic Models for Hospital Readmission Predictor API
======================================================

This module defines the request/response models for the FastAPI backend.
All models are designed to validate incoming requests and structure responses.
"""
...
class SHAPValue(BaseModel):
    """Model for individual SHAP value."""
    feature: str
    importance: float
    shap_value: float
