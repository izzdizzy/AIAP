...
export const READMISSION_FEATURE_LABELS = {
  ...
  prior_admissions: 'Prior Admissions (Past Year)',
  ...
  clinical_severity_score: 'Clinical Severity',
  emergency_ratio: 'Emergency Visit Ratio',
  long_stay: 'Extended Length of Stay',
  total_procedures: 'Total Procedures',
  high_lab_utilization: 'High Lab Utilization',
  high_diagnosis_count: 'High Diagnosis Count',
  emergency_admission: 'Emergency Admission',
  not_home_discharge: 'Non-Home Discharge Disposition',
  er_admission: 'ER Admission',
  age_comorbidity_interaction: 'Age-Comorbidity Factor',
  med_per_comorbidity: 'Meds Per Comorbidity Ratio',
  admissions_per_year: 'Annual Admissions Rate',
  emerg_inpatient_combo: 'Emergency-Inpatient Combination',
  insulin_complexity: 'Insulin Regimen Complexity',
  diabetes_med_intensity: 'Diabetes Medication Intensity',
  diabetes_risk_score: 'Diabetes Risk Index',
  cad_risk_score: 'CAD Risk Index',
  total_medications: 'Total Medications',
  on_insulin: 'On Insulin Therapy',
  oral_medications: 'Oral Diabetes Medications'
};
